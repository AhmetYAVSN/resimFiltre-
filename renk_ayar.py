...
class Pencere(QWidget):
    ...
    def setUI(self):
        ...
        self.bg = QLabel(self)
        self.bg.setGeometry(QtCore.QRect(0, 0, 671, 601))
        ...
        self.yazi = QLabel("Mavi Dershanem")
        self.renkodu = QLabel("")
        ...
        self.fontsize_lbl.setFont(QFont("Impact", 16, QFont.Bold))
        self.fontsize_lbl.setStyleSheet("background-color: rgb(200, 250, 50);")
        ...
        h_box2.addWidget(self.fontsize_lbl)
        ...
        self.qslider5.sliderMoved.connect(self.yaazi)

        self.setLayout(v_box)
        self.show()

    def yap(self):
        self.renkodu.setText("RGB KODU : ( {}, {} ,{} , {} ) ".format(self.qslider1.value(), self.qslider2.value(),
                                                                      self.qslider3.value(), self.qslider4.value()))
        palette = QPalette()
    ...
    def yaazi(self):
        self.yazi.setFont(QFont("Impact", self.qslider5.value(), QFont.Bold))
